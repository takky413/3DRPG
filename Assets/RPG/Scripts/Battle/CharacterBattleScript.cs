...
public class CharacterBattleScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //ターンが回ってきているキャラクターにカメラを向ける
        //if (gameObject.name.Equals("ユニティちゃん"))
        //{
        //    battleManager.ActivateCamera(0);
        //}
        //else if (gameObject.name.Equals("田北陽士"))
        //{
    ...
    public void DirectAttack()
    {
        ...
        if (targetCharacterStatus as AllyStatus != null)
        {
            ...
            //ここにカメラの設定を書く。最終的にはcurrentTarget.nameで場合分け
            //攻撃の対象となるキャラクターにカメラを向ける
            battleManager.ActivateCamera(0);
